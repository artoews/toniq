...
p.add_argument('--psf_window_size', type=int, default=10, help='psf window size in pixels; default=10')
p.add_argument('--unit_cell_size', type=int, default=10, help='unit cell size in pixels; default=10')
