...
This design was introduced in the original TONIQ paper to benchmark image quality near a total hip arthroplasty (THA) device. Instructions are provided for [adapting the design](tha-design/adapting-the-design.md) to a different THA device and/or container.
